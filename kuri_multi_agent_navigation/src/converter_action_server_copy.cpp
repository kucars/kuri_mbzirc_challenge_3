...
public:
    ...
    void goalCB(const kuri_msgs::ConvertPoseGoalConstPtr &goal)
    {
        ...
        //g1.position = actionServer.acceptNewGoal()->uav1LocalPose.position;
        //printf(" uav 1: x %f, y %f, z %f",g1.position.x,g1.position.y,g1.position.z);

//        g1.position.y = actionServer.acceptNewGoal()->uav1LocalPose.position.y;
//        g1.position.z = actionServer.acceptNewGoal()->uav1LocalPose.position.z;

        //g2.position = actionServer.acceptNewGoal()->uav2LocalPose.position;
        //printf(" uav 2: x %f, y %f, z %f",g2.position.x,g2.position.y,g2.position.z);

//        g2.position.y = actionServer.acceptNewGoal()->uav2LocalPose.position.y;
//        g2.position.z = actionServer.acceptNewGoal()->uav2LocalPose.position.z;

       // g3.position = actionServer.acceptNewGoal()->uav3LocalPose.position;
        //printf(" uav 3: x %f, y %f, z %f",g3.position.x,g3.position.y,g3.position.z);

//        g3.position.y = actionServer.acceptNewGoal()->uav3LocalPose.position.y;
//        g3.position.z = actionServer.acceptNewGoal()->uav3LocalPose.position.z;
...
//        result.ref1LocalPose.position.y = ref1LocalPose.position.y;
//        result.ref1LocalPose.position.z = ref1LocalPose.position.z;

        result.ref2LocalPose.position = ref2LocalPose.position;
//        result.ref2LocalPose.position.y = ref2LocalPose.position.y;
//        result.ref2LocalPose.position.z = ref2LocalPose.position.z;

        result.ref3LocalPose.position = ref3LocalPose.position;
//        result.ref3LocalPose.position.y = ref3LocalPose.position.y;
//        result.ref3LocalPose.position.z = ref3LocalPose.position.z;
