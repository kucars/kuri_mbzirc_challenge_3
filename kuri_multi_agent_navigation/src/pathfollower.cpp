...
public:
        ...
        actionName(name)
    {
        ...
        actionServer.registerGoalCallback(boost::bind(&PathFollowerAction::goalCB, this));
        actionServer.registerPreemptCallback(boost::bind(&PathFollowerAction::preemptCB, this));
        currentPoseSub = nh.subscribe("/uav_1/mavros/local_position/pose", 1, &PathFollowerAction::startPositionCallback, this);
...
int main(int argc, char** argv)
{
    ...
    PathFollowerAction planGeneration(ros::this_node::getName());
    ros::spin();
    return 0;
}
